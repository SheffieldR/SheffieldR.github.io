...
If you are interested in making contributions to R core - the code and documentation that gets distributed as base R - check out the information from [R Contributor
Site][rcontributors].
