...
software community._". These sessions are open to all regardless of your skill level and experience with writing R code,
documentation or using [Git][git], [GitHub][gh] or [GitLab][gl].
...
Students Union. During these sessions you can come along and seek support and offer help to those who have questions,
whether that is with some aspect of R, documentation, continuous integration, linting, tests or anything you have been
working on as part of Hacktoberfest.
...
If you are interested in making contributions to R core - the code and documentation that gets distributed as base R -
check out the information from [R Contributor Site][rcontributors].
