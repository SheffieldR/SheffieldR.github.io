...
Meeting is 2024-04-22 12:00-1:30 in [Regent Court](https://www.openstreetmap.org/relation/16201517), John Pemberton LT B (40). Sign up [here](https://www.meetup.com/sheffieldr-sheffield-r-users-group/events/300164087/). Remote attendance is possible using [Google Meet](https://meet.google.com/xka-dxah-sqf).
...
Navigating the complexities of health data, we address the challenges associated with the arrival of unforeseen data volumes. With a focus on scalability, we examine techniques to handle unexpectedly large data sets using packages like Arrow and DuckDB and Dplyr.
